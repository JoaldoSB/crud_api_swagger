package br.com.sorveteria.swagger;
...
public class SwaggerConfiguration {
	...
	public Docket detalheApi() {
		...
		docket.select().apis(RequestHandlerSelectors.basePackage("br.com.sorveteria")).paths(PathSelectors.any())
	...
	private ApiInfoBuilder informacoesApi() {
		...
		apiInfoBuilder.title("API - Sorveteria:");
